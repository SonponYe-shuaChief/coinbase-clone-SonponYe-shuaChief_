...
const NavBar = () => {
  ...
  const navSections = [
    { name: "Cryptocurrencies", component: null, to: "/explore" },
    { name: "Individuals", component: <IndividualsDropdown />, to: "/learn" },
    { name: "Business", component: <BusinessDropDown />, to: "/learn" },
    { name: "Institutions", component: <InstitutionsDropdown />, to: "/learn" },
    { name: "Developers", component: <DeveloperDropDown />, to: "/learn" },
    { name: "Company", component: <CompanyDropdown />, to: "/learn" },
  ];
